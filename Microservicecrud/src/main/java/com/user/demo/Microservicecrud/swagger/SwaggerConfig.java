...
public class SwaggerConfig {
	  ...
	  public static final Contact DEFAULT_CONTACT = new Contact( "Vijay Gharal",
	  "http://www.google.com", "vj3112thanekar@gmail.com");
	  
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo(
	  "Demo Bank API", "Demo Bank Service", "1.0", "urn:tos",
